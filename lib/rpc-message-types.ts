import { ObjectDescriptors } from './rpc-descriptor-types';
...
export type RPC_DescriptorsResultMessage = RPC_MessageBase & { action: 'descriptors', descriptors: ObjectDescriptors, error?: any };
...
export type RPC_FnResultMessageBase = RPC_MessageBase & { action: 'rpc_reply', success: boolean; result: any };
...
export type RPC_Message = RPC_GetDescriptorsMessage | RPC_DescriptorsResultMessage |
    RPC_FnCallMessage | RPC_RpcCallMessage | RPC_FnResultMessage | RPC_AsyncCallbackCallMessage | RPC_ObjectDiedMessage;
